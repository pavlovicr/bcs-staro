...
urlpatterns = [
    ...
    url(r'^dolocila/$', views.DolociloList.as_view(), name='dolocilo-list'),
    url(r'^dolocilo/(?P<pk>\d+)$', views.DolociloDetail.as_view(), name='dolocilo-detail'),
    url(r'^skupina_pogoji/$', views.SkupinaPogojaList.as_view(), name='skupina_pogoj-list'),
    url(r'^skupina_pogoj/(?P<pk>\d+)$', views.SkupinaPogojaDetail.as_view(), name='skupina_pogoj-detail'),
